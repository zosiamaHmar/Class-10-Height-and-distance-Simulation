/* Maths by Zosiama · Sets explainers — page player, captions toggle and exports.
...
(async function () {
  'use strict';
  const { P, TL, AUDIO, META } = window.SETS_DATA;
  const { createVideo, W, H, FPS } = window.SetsVideo;
